<template>
  <div class="reg">
    ...
    <form action="#" method="get" class="reg-login">
      ...
      <div class="lrBox">
        <div class="lrList2">
          <input type="text" placeholder="起个可爱的昵称" v-model="nikeName">
        </div>
        <div class="lrList">
          <input type="text" placeholder="输入手机号码或者邮箱号------/^\d/" v-model="tel">
          {{tel}}
        </div>
        <div class="lrList">
          <input type="text" placeholder="设置新密码（6-18位数字或字母" v-model="pass">
        </div>
        <div class="lrList">
          <input type="text" placeholder="再次输入密码" v-model="passAgain">
        </div>
      </div>
      <!--lrBox/-->
      <div class="lrSub">
